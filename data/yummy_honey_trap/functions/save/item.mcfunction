...
execute if entity @s[type=minecraft:axolotl] run data modify storage yummy_honey_trap: Item set value {id:"minecraft:axolotl_spawn_egg",Count:1b,tag:{}}
...
execute if entity @s[type=minecraft:glow_item_frame] run data modify storage yummy_honey_trap: Item set value {id:"minecraft:bee_spawn_egg",Count:1b,tag:{display:{Name:"{\"translate\":\"entity.minecraft.glow_item_frame\"}"}}}
execute if entity @s[type=minecraft:glow_squid] run data modify storage yummy_honey_trap: Item set value {id:"minecraft:glow_squid_spawn_egg",Count:1b,tag:{display:{Name:"{\"translate\":\"entity.minecraft.glow_squid\"}"}}}
execute if entity @s[type=minecraft:goat] run data modify storage yummy_honey_trap: Item set value {id:"minecraft:goat_spawn_egg",Count:1b,tag:{display:{Name:"{\"translate\":\"entity.minecraft.goat\"}"}}}
...
execute if entity @s[type=minecraft:marker] run data modify storage yummy_honey_trap: Item set value {id:"minecraft:bee_spawn_egg",Count:1b,tag:{display:{Name:"{\"translate\":\"entity.minecraft.marker\"}"}}}
